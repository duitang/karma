...
//		Thread.sleep(1000 * 1000);
	...
	public void testAll() throws AvroRemoteException {
		...
		lst.add("1");
		keys.setKeys(lst);
		Assert.assertEquals(m.toString(), cli.cat_mgetstring(keys).toString());
...
class MockL2Service implements L2Service {
	...
	@Override
	public Map<CharSequence, CharSequence> cat_mgetstring(Keys keys) throws AvroRemoteException {
