...
public interface L2Service {
  ...
  java.lang.Void audit(java.lang.String clientid, java.lang.String name, boolean failed, long ts, long elapse) throws org.apache.avro.AvroRemoteException;

  @SuppressWarnings("all")
  public interface Callback extends L2Service {
    public static final org.apache.avro.Protocol PROTOCOL = com.duitang.service.karma.l2.L2Service.PROTOCOL;
    ...
    void audit(java.lang.String clientid, java.lang.String name, boolean failed, long ts, long elapse, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
  }
}