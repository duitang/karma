...
public class ServerBootstrapV2 {
	...
	protected String SERVICE_INTERFACE = ServerBootstrapV2.class.getPackage().getName() + ".FacadeServiceImpl";
	...
	protected static Class genInterface(final String destName, Class[] clz) {
		...
		Class<?> klass = new ClassLoader(ServerBootstrapV2.class.getClassLoader()) {
